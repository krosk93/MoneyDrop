package com.nijikokun.register.payment.md;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new com.nijikokun.register.payment.md.methods.iCo6());
        this.addMethod("iConomy", new com.nijikokun.register.payment.md.methods.iCo5());
        this.addMethod("iConomy", new com.nijikokun.register.payment.md.methods.iCo4());
        this.addMethod("BOSEconomy", new com.nijikokun.register.payment.md.methods.BOSE6());
        this.addMethod("BOSEconomy", new com.nijikokun.register.payment.md.methods.BOSE7());
        this.addMethod("Essentials", new com.nijikokun.register.payment.md.methods.EE17());
        this.addMethod("MultiCurrency", new com.nijikokun.register.payment.md.methods.MCUR());
    }
